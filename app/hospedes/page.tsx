...
export default function HospedesPage() {
    return (
        <div className="flex h-screen font-display bg-gray-100 text-gray-900">
            <Sidebar />
            <main className="flex-1 flex flex-col h-screen overflow-y-auto ml-64">
                <header className="bg-white border-b border-gray-200 p-4 flex justify-between items-center sticky top-0 z-10">
                    <div>
                        <h2 className="text-xl font-bold text-gray-800">Gerenciamento de Hóspedes</h2>
                    </div>
